...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/drc_cfg_AZ.txt:system/etc/drc/drc_cfg_AZ.txt \
    ...
    $(LOCAL_PATH)/audio/surround_sound_rec_AZ.cfg:system/etc/surround_sound_3mic/surround_sound_rec_AZ.cfg
